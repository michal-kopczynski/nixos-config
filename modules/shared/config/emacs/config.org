...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/michal/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/michal/bin" "/profile/bin" "/Users/michal/.npm-packages/bin" "/Users/mk058946/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
